                      ...
                      std::vector<cv::DMatch> &matches, std::string descriptorType, std::string matcherType, std::string selectorType)
{
    ...
    { 
        ...
        */
        ...
        matcher = cv::BFMatcher:: create(normType, crossCheck);
        //cout << "MAT_BF matching cross check : " << crossCheck << endl;
    }
...
void descKeypoints(vector<cv::KeyPoint> &keypoints, cv::Mat &img, cv::Mat &descriptors, string descriptorType)
{
    ...
    {
        throw invalid_argument(" Use BRIEF, BRISK, ORB, AKAZE, FREAK, SIFT");
    }
...
{
    // compute detector parameters based on image size
    int blockSize = 2;       //  for every pixel, blocksize x blocksize neighborhood is considered
...
void detKeypointsModern(std::vector<cv::KeyPoint> &keypoints, cv::Mat &img, std::string detectorType, bool bVis)
{
    ...
    {
       throw invalid_argument(detectorType + " is not a valid detectorType. only FAST, BRISK, ORB, AKAZE, SIFT are valid");
